...
var generateNavbar = function(req, html) {
  ...
  return html + '<body><ul class="nav nav-tabs navbar-fixed-top"><img class="navbar-brand" src="http://' + host + '/hamster-transparent.png"><li role="presentation" class="active"><a href="#">Stack Overflow</a></li><li role="presentation"><a href="http://' + host + '/flockdocs/' + lib + '/' + method + '">Comments</a></li><li role="presentation"><a href="http://' + host + '/annotation/' + lib + '/' + method + '">Annotation</a></li></ul>';
};
